...
function ProtectedRoute({
  ...
  role: 'Administrator' | 'Employee' | 'Secretary' | 'IT Personnel'
  children: ReactNode
}) {
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route
          path="/secretary"
          element={
            <Navigate to="/secretary/incidents" replace />
          }
        />
        ...
        <Route
          path="/it/incidents"
          element={
            <ProtectedRoute role="IT Personnel">
              <ITPersonnelIncidents />
            </ProtectedRoute>
          }
        />
